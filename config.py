...
def set_args():
    ...
    parser.add_argument('--train_data', default='./data/ATEC/atec_nlp_sim_train.csv', type=str, help='训练数据集')
    parser.add_argument('--test_data', default='./data/ATEC/atec_nlp_sim_train_add.csv', type=str, help='测试数据集')
    ...
    parser.add_argument('--val_batch_size', default=128, type=int, help='验证批次大小')
